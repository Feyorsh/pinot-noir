...
var DefaultKeyMap = KeyMap{
	...
	NextSuggestion:          key.NewBinding(key.WithKeys("down", "ctrl+j")),
	PrevSuggestion:          key.NewBinding(key.WithKeys("up", "ctrl+k")),
}
...
func (m Model) Update(msg tea.Msg) (Model, tea.Cmd) {
	...
	case tea.KeyMsg:
		...
		// debounce
		m.tag++
		cmds = append(cmds, tea.Tick(m.DebounceDuration, func(_ time.Time) tea.Msg {
				return updateSuggestionsMsg(m.tag)
		}))
